...
rem
rem We don't support a touch screen.
rem
set BSP_NOTOUCH=1

rem
rem IMGFLASH=1 configures the kernel to be read off the SD card. 
rem Remove this env var if you want to download the kernel via KITL
rem
set IMGFLASH=1
